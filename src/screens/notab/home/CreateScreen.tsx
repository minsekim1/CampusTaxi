...
export type CreateScreenNavigationProp = StackNavigationProp<HomeNoTabNavigationParamList, 'CreateScreen'>;
    ...
    const onPressPosSetButton = async (
        ...
        if (myCoord.latitude < 38.64 && myCoord.latitude > 33
            ...
            if (type == 'start' || type == 'end') {
                ...
                let r:any = await AsyncStorage.getItem('onPressPosSetButton(' + myCoord.latitude+',' + myCoord.longitude+')');
                if (!r) {
                    r = await axios.post(
                    ...
                    AsyncStorage.setItem('onPressPosSetButton(' + myCoord.latitude + ',' + myCoord.longitude + ')', JSON.stringify(r));
                } else
                    r = JSON.parse(r);
    ...
    return(
        <>
            ...
            {selectRoom?.start_lon && selectRoom?.end_lon ?
                ...
                <SelectBottomPosView type={params.type}
...
{/* <Button onPress={() => navigate("CreateScreenDetails")} title={"버튼"}/> */}