...
class ChatFlatList extends React.Component {
  //#region 변수 & 함수
 constructor(props) {
    super(props);
    this.state = {
      ...
      <View style={campusStyle.View.backgroundColorBlue}>
        <View>
          <View style={campusStyle.View.mainHeaderBackground}>
            ...
            <Image
              style={campusStyle.Image.mainImage}
              source={require(adImageSrc)}
            />
          </View>
        </View>
      </View>
      ...
      <View style={campusStyle.View.mainItemView}>
        <View style={campusStyle.View.rowflex}>
          <View style={campusStyle.View.container}>
            <MenuItem
              filter="등교"
              imageURL={require("../../Assets/Images/school.png")}
          ...
          <View style={campusStyle.View.container}>
            <MenuItem
              filter="야작"
              imageURL={require("../../Assets/Images/pen.png")}
              navigation={navigation}
            />
          </View>
        </View>
        <View style={campusStyle.View.rowflex}>
          <View style={campusStyle.View.container}>
            <MenuItem
              filter="독서실"
              imageURL={require("../../Assets/Images/study.png")}
              navigation={navigation}
            />
          </View>
          <View style={campusStyle.View.container}>
        ...
        <View style={campusStyle.View.rowflex}>
          <View style={campusStyle.View.container}>
            <MenuItem
              filter="클럽"
              imageURL={require("../../Assets/Images/club.png")}
              navigation={navigation}
            />
          </View>
          <View style={campusStyle.View.container}>
            <MenuItem
              filter="스키장"
              imageURL={require("../../Assets/Images/ski.png")}
              navigation={navigation}
            />
          </View>
          <View style={campusStyle.View.container}>
